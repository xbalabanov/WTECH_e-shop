      ...
      <section class="profile-dashboard" aria-label="Profile orders overview">
        <div class="profile-dashboard-inner">
          ...
          <div class="profile-main">
            ...
            >
              <h2 id="settings-title" class="profile-subpage-title">
                Profile Settings
              </h2>
              ...
              <form action="{{ route('profile.settings.update') }}" method="post">
                ...
                <article class="settings-card" aria-labelledby="account-title">
                  <h3 id="account-title" class="settings-card-title">
                    Account Information
                  </h3>

                  <div class="settings-row">
                    <label class="settings-label" for="full-name"
                      >Full Name</label
                    >
                    <input
                ...
                <article class="settings-card" aria-labelledby="security-title">
                  <h3 id="security-title" class="settings-card-title">
                    Security
                  </h3>
                  ...
                  <div class="settings-row">
                    <label class="settings-label" for="confirm-password"
              ...
              <div class="settings-actions">
                <button class="settings-secondary-btn" type="button">
                  Cancel
                </button>
